...
class qe_input():
    def __init__(self, matter=None, light=None):
        ...
        self.matter = matter
        self.light = light
        self.input = matter.params
        self.element = None  # For compatibility with Calculation class
        
    def write_to_file(self, file_path):
        """Write QE input to file."""
        # This is just a placeholder - the actual QE input is handled by the Calculation class
        with open(file_path, 'w') as f:
            f.write("# QE input will be generated by the Calculation class\n")
...
class Input():
    def __init__(self, target='xas', name='ocean', matter=None, light=None):
        ...
        if 'xas' in target:
            ...
            print('qe_input')
            self.content = qe_input(matter=self.matter, light=self.light)
        else:
            print('Wrong target')
